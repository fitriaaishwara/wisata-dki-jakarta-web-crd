<?php
	include('koneksi.php');
	$datawisata = "select * from tbl_wisata where idw =".$_GET['idw'];
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <img src="gambar/<?php echo $data_vc['gambar']?>" alt="" class="img-fluid">
                    <h1 class="mt-4 mb-3"><?php echo $data_vc['nama_wisata']?></h1>
                    <p>
                        ...
                        <div class="card-body">
                            ...
                            <form action="simpan_pesanan.php"method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_identitas" class="form-control" id="no_identitas" maxlength="16" minlength="16"required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal" min="<?= date('d-m-y') ?>" class="form-control" id="tanggal" required>
                                </div>
                                <div class="form-group">
